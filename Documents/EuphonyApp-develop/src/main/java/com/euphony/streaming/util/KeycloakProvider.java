 ...
 * Esta clase proporciona métodos para obtener recursos como usuarios y roles en el contexto de un Realm específico.
 *
 * Uso:
...
public class KeycloakProvider {
     ...
     * Este método crea una instancia de Keycloak para conectarse a la API de Keycloak y acceder a los recursos del realm.
     *
    ...
    public static RealmResource getRealmResource() {
        Keycloak keycloak = KeycloakBuilder.builder()
                ...
                .resteasyClient(new ResteasyClientBuilderImpl()
                        .connectionPoolSize(10)       // Tamaño del pool de conexiones para mejorar la concurrencia
                        .build())
                .build();

        // Devuelve el recurso del realm en el que se realizarán las operaciones
     ...
     * Este método permite obtener los roles asignados a un usuario en el contexto de diferentes clientes de Keycloak.
     *
